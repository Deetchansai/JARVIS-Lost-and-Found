...
- source_sentence: Lost brown leather belt in locker room
  sentences:
...
- source_sentence: Found tan leather belt in the locker area
  sentences:
...
- source_sentence: Found Dell branded laptop messenger bag
  sentences:
...
| cosine_mrr@10       | 0.4792     |
| cosine_map@100      | 0.4792     |
...
* Approximate statistics based on the first 32 samples:
  ...
  | type     | string                                                                            | string                                                                            |
  | modality | text                                                                              | text                                                                              |
  | details  | <ul><li>min: 8 tokens</li><li>mean: 11.34 tokens</li><li>max: 17 tokens</li></ul> | <ul><li>min: 8 tokens</li><li>mean: 11.34 tokens</li><li>max: 17 tokens</li></ul> |
* Samples:
  | sentence_0                                                               | sentence_1                                                                   |
  |:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------|
  | <code>Lost leather wallet with university logo at sports complex</code>  | <code>Found brown wallet with campus crest in gym lobby</code>               |
  | <code>Found brown wallet with campus crest in gym lobby</code>           | <code>Lost leather wallet with university logo at sports complex</code>      |
  | <code>Cannot find black Sony WH-1000XM headphones in dorm laundry</code> | <code>Found over-ear Sony noise cancelling headphones in laundry room</code> |
